<template>
  <div class="announcement-container">
    <div class="announcement-title"><h2>最新消息/訊息公告</h2></div>
...
const goToDetail = (announcement) => { if (announcement?.id != null) router.push({ path: `/publication/news-detail/${announcement.id}`, state: { news: announcement } }) }
</script>
